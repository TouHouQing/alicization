...
The Alicization ecosystem is moving toward:
...
Alicization plugins orchestration should behave like an extensible runtime kernel:
...
- [Alicization Plugin Platform](./architecture.md)
