...
export const governedMindFallbackMessageFallbacks = {
  'en': {
    ...
    'mind-repair.required-tool-missing': 'The model did not call the required tool, so the operation was not executed.',
  ...
  'zh-Hans': {
    ...
    'mind-repair.required-tool-missing': '模型未调用本轮要求的工具，操作没有执行。',
