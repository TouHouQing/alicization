...
export const governedMindFallbackMessageFallbacks = {
  'en': {
    ...
    'mind-repair.provider-continuation-timeout': 'The tool completed, but the Provider timed out while producing the final reply ({provider} / {model}).',
    'mind-repair.provider-continuation-incomplete': 'The tool completed, but the Provider did not return a final reply.',
    'mind-repair.preparation-timeout': 'The dialogue preparation phase timed out before the Provider stream started ({provider} / {model}).',
    ...
    'mind-repair.stream-timeout': 'Provider timed out before the first response ({provider} / {model}).',
    ...
    'mind-repair.tool-execution': 'Tool execution failed ({tool}, {code}): {message}.',
  ...
  'zh-Hans': {
    ...
    'mind-repair.provider-continuation-timeout': '工具已完成，但 Provider 等待最终回复超时（{provider} / {model}）。',
    'mind-repair.provider-continuation-incomplete': '工具已完成，但 Provider 没有返回最终回复。',
    'mind-repair.preparation-timeout': '对话准备阶段超时，Provider 还没有开始返回（{provider} / {model}）。',
    ...
    'mind-repair.stream-timeout': 'Provider 等待首个响应超时（{provider} / {model}）。',
    ...
    'mind-repair.tool-execution': '工具执行失败（{tool}，{code}）：{message}。',
