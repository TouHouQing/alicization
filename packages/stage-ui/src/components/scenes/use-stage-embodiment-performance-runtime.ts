...
export function useStageEmbodimentPerformanceRuntime(options: UseStageEmbodimentPerformanceRuntimeOptions) {
  ...
  watch(
    [
      ...
      () => options.upcomingSpeechSegment?.value?.cue?.rendererHints?.preferredPauseMode ?? '',
      () => options.upcomingSpeechSegment?.value?.cue?.rendererHints?.preferredLipsyncMode ?? '',
      () => options.upcomingSpeechSegment?.value?.cue?.rendererHints?.preferredVoiceMode ?? '',
      () => options.upcomingSpeechSegment?.value?.cue?.rendererHints?.preferredPacingMode ?? '',
