    ...
    <div class="flex-1 overflow-y-auto space-y-4">
      ...
      <div class="grid gap-3 md:grid-cols-3">
        <label class="space-y-2">
          ...
          <select v-model="draft.calibration!.silenceReconnect" class="w-full border-2 border-neutral-100 rounded-lg bg-neutral-50 px-2 py-2 text-sm outline-none dark:border-neutral-900 dark:bg-neutral-950">
        ...
        <label class="space-y-2">
          ...
          <select v-model="draft.calibration!.comfortStyle" class="w-full border-2 border-neutral-100 rounded-lg bg-neutral-50 px-2 py-2 text-sm outline-none dark:border-neutral-900 dark:bg-neutral-950">
        ...
        <label class="space-y-2">
          ...
          <select v-model="draft.calibration!.jealousyStyle" class="w-full border-2 border-neutral-100 rounded-lg bg-neutral-50 px-2 py-2 text-sm outline-none dark:border-neutral-900 dark:bg-neutral-950">
