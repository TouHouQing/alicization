...
describe('alicization performance manifest clamp', () => {
  ...
  it('exposes memory workbench eventa invokes through the desktop bridge', () => {
    ...
    expect(source).toContain('electronAlicizationMemoryWorkbenchManageWorkingMemoryCleaningQueue')
    expect(source).toContain('electronAlicizationMemoryWorkbenchReindexEmbeddings')
    expect(source).toContain('electronAlicizationMemoryWorkbenchManageSemanticScaleJobs')
    ...
    expect(source).toContain('electronAlicizationMemoryWorkbenchListReplaySessions')
    ...
    expect(source).toContain('memoryWorkbenchManageWorkingMemoryCleaningQueue')
    expect(source).toContain('memoryWorkbenchReindexEmbeddings')
    expect(source).toContain('memoryWorkbenchManageSemanticScaleJobs')
    expect(source).toContain('memoryWorkbenchListEmbeddingModels')
    expect(source).toContain('memoryWorkbenchTestEmbeddingConnection')
    expect(source).toContain('memoryWorkbenchListReplaySessions')
