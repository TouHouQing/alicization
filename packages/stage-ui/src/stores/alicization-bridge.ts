...
export interface AlicizationListHumanlikeMemoryAuditPayload extends SharedAlicizationListHumanlikeMemoryAuditInput {}
export interface AlicizationCorrectHumanlikeMemoryAuditPayload extends SharedAlicizationCorrectHumanlikeMemoryAuditInput {}
...
interface AlicizationBridge {
  ...
  memoryWorkbenchGetPersonaRuntimeConfig?: () => Promise<AlicizationPersonaRuntimeConfigState>
  memoryWorkbenchSetPersonaRuntimeConfig?: (payload: Omit<AlicizationPersonaRuntimeConfigPayload, 'cardId'>) => Promise<AlicizationPersonaRuntimeConfigState>
  memoryWorkbenchTestPersonaRuntime?: (payload: Omit<AlicizationPersonaRuntimeConfigPayload, 'cardId'>) => Promise<AlicizationPersonaRuntimeConnectionResult>
  ...
  memoryWorkbenchManageSemanticScaleJobs?: (payload: Omit<AlicizationMemorySemanticScaleJobPayload, 'cardId'>) => Promise<AlicizationMemorySemanticScaleJobResult>
  ...
  listHumanlikeMemoryAudit?: (payload: AlicizationListHumanlikeMemoryAuditPayload) => Promise<AlicizationHumanlikeMemoryAuditEntry[]>
  correctHumanlikeMemoryAudit?: (payload: AlicizationCorrectHumanlikeMemoryAuditPayload) => Promise<AlicizationHumanlikeMemoryCorrectionRecord>
