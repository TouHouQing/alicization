...
```shell
ni @proj-alicization/ui -D # from @antfu/ni, can be installed via `npm i -g @antfu/ni`
pnpm i @proj-alicization/ui -D
yarn i @proj-alicization/ui -D
npm i @proj-alicization/ui -D
```
