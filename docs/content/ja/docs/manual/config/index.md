---
title: 設定ガイド
description: Project Alicization デスクトップ版の使い方
---

## 設定

システムトレイの設定を開いて、Alicization のテーマカラーを変更したり、Live2D (2D) または VRM (3D、Grok Companion など) の別のモデルに切り替えたりするなど、さらにカスタマイズすることができます。
...
モデルをロードした後、Alicization を再起動する必要があります。
:::
