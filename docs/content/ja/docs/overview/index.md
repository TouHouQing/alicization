---
title: これはどんなプロジェクト？
description: Project Alicization のユーザーインターフェースを知る
---
...
だからこそ Project Alicization は、もうひとつの選択肢を用意しました。
...
デスクトップ版は VTuber 配信や computer-use（PC 操作代行）、ローカル LLM へのアクセスなど高度な用途に向いています。ローカル推論なら、Alicization を動かすために大量のトークンを払う必要もありません。
...
Project Alicization の UI を設計・改善するための参考は [Design Guidelines](../contributing/design-guidelines/resources) を参照してください。
