...
- [ ] **Step 1: Add a failing schema isolation test**
...
- [ ] **Step 3: Recreate both tables with card-scoped schemas**
...
- [ ] **Step 4: Thread `cardId` through every facts/consolidation facade**
...
- [ ] **Step 5: Make consolidation rebuild card-local**
...
- [ ] **Step 6: Run focused memory tests and commit**
...
- [ ] **Step 1: Add failing tests for SQL pagination**
...
- [ ] **Step 2: Implement the projection tables**
...
- [ ] **Step 3: Implement cursor encoding and SQL keyset queries**
...
- [ ] **Step 4: Rebuild the projection from card-scoped source rows**
...
- [ ] **Step 5: Route Workbench list and recall candidates through the index**
...
- [ ] **Step 2: Add job and item tables**
...
- [ ] **Step 3: Implement claim/process/finalize transitions**
...
- [ ] **Step 4: Add startup crash recovery and worker lifecycle**
...
- [ ] **Step 5: Extend Eventa/bridge/store/UI**
...
- [ ] **Step 4: Route recall and health through the adapter**
...
- [ ] **Step 5: Verify packaging paths and commit**
...
- [ ] **Step 2: Add dataset/version/example/export tables**
...
- [ ] **Step 3: Implement cleaning and deterministic dedupe**
...
- [ ] **Step 4: Implement export and rollback**
...
- [ ] **Step 5: Add Workbench controls and Chinese i18n**
...
- [ ] **Step 1: Add cross-card and restart regression scenarios**

Prove card A data cannot leak into card B across facts, consolidation, search, vector, reindex, and persona export.

- [ ] **Step 2: Add large-data pagination and job recovery scenarios**
