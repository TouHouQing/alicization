...
│                                             │
│   ┌────────────┐         ┌─────────────┐    │
│   │Alicization Adapter│         │ MCP Adapter │    │
...
- **Adapters**: Alicization Server SDK, MCP SDK
...
#### 5.1.1 Alicization Adapter

Provides integration with the Alicization LLM platform, handling event-driven communication.
...
### 9.2 Integrating as Alicization Module
...
async function startAIRIModule() {
  ...
  console.info('Twitter service running as Alicization module')
}
```
