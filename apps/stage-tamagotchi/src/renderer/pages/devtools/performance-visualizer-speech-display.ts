...
const speechDisplayTextLabels: Record<string, string> = {
  ...
  'continuity-frame-summary': '同一生命线帧摘要',
  'continuity-frame-aligned': '同一生命线帧对齐',
  'continuity-frame-mismatch-drivers': '同一生命线漂移驱动',
  'continuity-execution-summary': '同一生命线执行摘要',
  'continuity-execution-aligned': '同一生命线执行对齐',
  'continuity-execution-mismatch-drivers': '同一生命线执行漂移驱动',
