  ...
  it('builds normalized authority entries for live2d and vrm surfaces', () => {
    const entries = buildAuthoritySummaryEntries({
      live2d: {
        ...
        consumedVoiceSummary: 'zh-CN | closure=0.84 | precision=0.90 | provenance=authority-bound | segment=segment-live2d-1 | source=prosody-authority',
    ...
    expect(entries).toEqual([
      ...
      },
      {
        ...
        lane: 'voice',
        cueId: 'segment-live2d-1',
        planned: 'zh-CN | closure=0.84 | precision=0.90 | provenance=authority-bound | segment=segment-live2d-1 | source=prosody-authority',
        consumed: 'zh-CN | closure=0.84 | precision=0.90 | provenance=authority-bound | segment=segment-live2d-1 | source=prosody-authority',
        source: 'prosody-authority',
        aligned: true,
      },
      {
      ...
      },
      {
        ...
        lane: 'voice',
        cueId: 'segment-vrm-1',
        planned: 'zh-CN | closure=0.84 | precision=0.90 | provenance=authority-bound | segment=segment-vrm-1 | source=prosody-authority',
        consumed: 'zh-CN | closure=0.84 | precision=0.90 | provenance=authority-bound | segment=segment-vrm-1 | source=prosody-authority',
        source: 'prosody-authority',
        aligned: true,
      },
      {
    ...
    expect(rows).toEqual([
      {
        ...
        cueText: '继续看这里。',
        surfaces: ['live2d'],
        lanes: ['expression', 'lipsync', 'voice', 'settle'],
        aligned: true,
