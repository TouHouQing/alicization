...
describe('performance visualizer self evolution focus history pattern workflow', () => {
  ...
  it('keeps quieter face+lipsync+voice same-her carry explicit in workflow guidance instead of flattening it into generic body-loss wording', () => {
    expect(buildSelfEvolutionFocusHistoryPatternWorkflow({
      pattern: {
  ...
  it('keeps quieter motion+lipsync+voice same-her carry explicit in workflow guidance instead of flattening it into generic body-loss wording', () => {
    expect(buildSelfEvolutionFocusHistoryPatternWorkflow({
      pattern: {
