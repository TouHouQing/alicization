...
export function resolveAlicizationProjectStateCoverage(): AlicizationProjectStateCoverageEntry[] {
  return [
    ...
    },
    {
      ...
      area: 'reply',
      status: 'verified',
      responsibility: 'Visible-reply final project awareness is registered across semantic judge, second-pass rewrite, final settlement, and realization; preserve verified project facts without slogans.',
