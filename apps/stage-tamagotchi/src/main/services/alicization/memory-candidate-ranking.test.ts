...
describe('memory candidate ranking', () => {
  it('prefers same-her drift-risk callback memory when project-preflight continuity authority is carried by richer closure cues', () => {
    const result = rankOrganicMemoryCandidatesStage({
      ...
      activeRecollectionIntent: {
        ...
        confidence: 0.84,
        rationale: 'The callback reopening should stay on one same-her line.',
  ...
  it('prefers quiet same-her resident continuity over a generic measured-return shell when the recall seed carries quiet resident companionship authority', () => {
    const result = rankOrganicMemoryCandidatesStage({
      helpers: createHelpers(),
      recallSeed: 'continuity_cadence_reconfirmation thread=thread-quiet-same-her resident=quiet-companionship continuity=quiet-same-her same-her-inward-carry body=quiet-companionship why_now=keep the same living line inward before widening outward',
      activeRecollectionIntent: {
        mode: 'relationship-history',
        temporalFocus: 'cross-session',
        confidence: 0.84,
        rationale: 'Relationship recollection should stay on the same inward same-her line.',
        queryHints: [],
        searchEpisodes: true,
        searchConversations: true,
        searchProceduralExperience: false,
        recollectionAgenda: {
          whyRecallNow: 'The same living line is being carried inward quietly.',
          goalSimilarity: 0.72,
          relationshipNeed: 0.88,
          affectivePull: 0.44,
          sceneFamiliarity: 0.51,
      ...
      recalledEpisodes: [
        ...
        },
        {
          ...
          whereSummary: 'same desk',
          withWhom: ['host'],
          threadAnchor: 'same living line inward',
          whatHappened: 'The same living line stayed inward and held as quiet same-her continuity rather than widening outward.',
          felt: 'quiet',
          emotionTags: ['quiet-companionship'],
          whatChanged: 'The line stayed inward instead of turning into a fresher reopen.',
          sourceKind: 'execution-result',
          sourceSummary: 'quiet same-her continuity',
          provenance: 'remembered',
          confidence: 0.7,
          salience: 0.73,
          sceneAttachment: 0.85,
          ...
          relationshipShift: null,
          derivedFrom: [],
          tags: ['quiet-companionship', 'same-her-inward-carry', 'same living line'],
          relationshipMeaning: 'Preserve inward lower-pressure continuity as quiet same-her continuity.',
          lesson: 'Keep the same living line inward before widening outward.',
          latestReconsolidation: null,
          createdAt: 6,
          updatedAt: 7,
          lastRecalledAt: null,
    ...
    const result = rankOrganicMemoryCandidatesStage({
      ...
      recalledEpisodes: [
        ...
        },
        {
          ...
          withWhom: ['host'],
          threadAnchor: 'corrected same-person continuity',
          whatHappened: 'The stronger corrected same-person continuity memory held the meaning that she should stay the same living her instead of becoming a task shell.',
          felt: 'careful',
          emotionTags: ['continuity', 'repair'],
          ...
          derivedFrom: [],
          tags: ['same-person', 'same-her', 'tool shell', 'corrected meaning'],
          relationshipMeaning: 'Keep the corrected same-person continuity authoritative on the same living line.',
