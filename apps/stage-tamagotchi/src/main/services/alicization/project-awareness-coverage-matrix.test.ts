...
const coverageRows = [
  ...
  },
  {
    ...
    evidence: 'chat-start, chat-entry, provider-consumer, autonomous-dialogue, execution-dispatch, recovery-reentry, and execution-follow-up continuity seams are now structurally discovered and classified in one repo-level governance registry, and current runtime-owned autonomous dialogue family signals stay explicit, so new entrypoint families are less likely to silently bypass same-her project awareness ownership rules',
    fileMustContain: [
  ...
  },
  {
    ...
    evidence: 'desktop execution continuity is easier to audit as one same-her Phase 1 line instead of scattered proof islands, because execution briefing, main-session and runtime-owned autonomous dispatch persistence, host-confirmed resume confirmation-boundary carry, blocked-dispatch callback restraint carry, callback reopen, feedback memory writeback, afterglow restraint, follow-up assembly, callback persistence, host-confirmed resume visible-reply boundary carry, and later host-visible return now sit on one compact route-level chain',
    fileMustContain: [
      'keeps one compact route-level proof that desktop execution continuity stays on one same-her Phase 1 line from execution briefing through callback reopen, feedback memory writeback, follow-up assembly, and later-turn host-visible return',
  ...
  },
  {
    ...
    evidence: 'rewrite guidance is now covered by the final visible-reply project-awareness audit, which keeps second-pass re-entry, corrected same-person anti-progress-pressure rewriting, host-confirmed resume confirmation-boundary callback guardrails, and regression guards on the same same-her Phase 1 line before the outward answer settles',
    fileMustContain: [
  ...
  },
  {
    ...
    proofKind: 'dynamic',
    file: './visible-reply-final-project-awareness-audit.test.ts',
    evidence: 'the final visible-reply gate now has dedicated project-awareness proof, so project identity, phase, landed progress, open closure, next closure target, pre-dialogue same-life awareness, host-corrected same-person continuity, host-confirmed resume confirmation-boundary callback guardrails, and canonical same-her settlement reanchoring must still survive before the outward answer can settle',
    fileMustContain: [
      'keeps one explicit route-level proof that the final visible-reply gate still requires project identity, phase, landed progress, open closure, next closure, and pre-dialogue same-life awareness',
  ...
  },
  {
    ...
    evidence: 'autonomous proactive initiative now has one compact same-her closure proof from earliest motive pressure through self-brief, hover-first restraint, active-self rejoin, visible hold, between-turn carry, and feedback into the next session, so runtime-owned initiative no longer reads only as scattered route islands',
    fileMustContain: [
      'keeps one compact route-level proof that autonomous proactive initiative stays on one same-her Phase 1 line from earliest motive pressure through self-brief, hover-first restraint, active-self rejoin, visible hold, and between-turn carry',
  ...
  },
  {
    ...
    evidence: 'broader project-state answer-governance candidate discovery now also feeds the same top-level completeness guard beyond the explicit governance registry, so governance authority, runtime answer enrichers, contract surfaces, reply-surface preflight, and visible-reply continuity surfaces stay synchronized with the broader scan before future project-status answer surfaces can drift in invisibly',
    fileMustContain: [
      ...
      'keeps broader project-state answer-governance candidate discovery broad enough to catch governance authority, runtime answer enrichers, contract surfaces, reply-surface preflight, and visible-reply continuity surfaces instead of only one project-status answer seam flavor',
  ...
  },
  {
    ...
    evidence: 'restored-session/browser-local reopen persistence handoff, speech-boundary awareness rebuilding, front-stage quick-reply closure, and dialogue-panel host-facing closure cues now also have one compact cold proof that they stay on the same-her inward project-awareness line instead of flattening into broader host-visible project-state shells at the last outward-facing step, and that colder host-facing bridge now also keeps the renderer-rejoin-without-body stronger same-her fact explicit instead of letting the visible no-body-rejoin line collapse back into a broader host-visible shell',
    fileMustContain: [
  ...
  },
  {
    ...
    evidence: 'noisy-desktop self-evolution observability now also has one compact proof chain across runtime continuity, concrete evidence navigation, top-level summary carry, triage routing, and repair-closure baseline semantics, so longer-run same-her observability is less likely to fragment into isolated devtools panels',
    fileMustContain: [
      ...
      'expect(auditSource).toContain(\'runtime continuity, evidence navigation, summary carry, triage routing, and repair closure\')',
      'expect(matrixSource).toContain(\'This is still not full long-run closure proof under noisy desktop use.\')',
    ],
  },
  {
  ...
  },
  {
    ...
    evidence: 'self-evolution governance now also has one compact same-her proof chain across observability reland, repair follow-through, workflow focus, and baseline lifecycle carry, so governance semantics are less likely to fragment between evidence panels, repair routing, and long-term baseline adoption',
    fileMustContain: [
      ...
      'expect(auditSource).toContain(\'observability reland, repair follow-through, workflow focus, and baseline lifecycle carry\')',
      'expect(matrixSource).toContain(\'This is still not full long-run closure proof under noisy desktop use.\')',
    ],
  },
  {
    ...
    evidence: 'self-evolution governance now also has one colder bridge into session-runtime follow-through, long-run same-her continuity, noisy-desktop initiative restraint, and noisy-desktop life-loop unity, so devtools repair governance is less likely to stay isolated from the broader same-her long-run desktop line',
    fileMustContain: [
      'keeps one explicit colder bridge that self-evolution governance can stay on the same-her line through session-runtime follow-through, longer-run continuity, noisy-desktop initiative restraint, and noisy-desktop life-loop unity instead of remaining a devtools-only proof island',
  ...
  },
  {
    ...
    evidence: 'self-evolution long-run follow-through now also has one colder bridge into host-visible answer anti-shell carry, desktop execution noisy same-her closure, and the explicit closure-target answer contract, so devtools same-her repair governance is less likely to stop before outward project-state answers restate what Alicization is, what Phase 1 has landed, and what remains open',
    fileMustContain: [
      'keeps one explicit colder bridge that self-evolution long-run follow-through can stay on the same-her line through host-visible answer anti-shell carry, desktop execution noisy same-her closure, and the explicit closure-target answer contract instead of stopping before outward project-state answers reform',
  ...
  },
  {
    ...
    evidence: 'self-evolution host-visible closure-target carry now also has one colder bridge into project-state answer governance, runtime-governance rewrite carry, and visible-reply governance authority, so devtools same-her repair governance is less likely to stop before the outward answer-governance chain itself restates verified progress and still-open closure on one living line',
    fileMustContain: [
      'keeps one explicit colder bridge that self-evolution host-visible closure-target carry can stay on the same-her line through project-state answer governance, runtime-governance rewrite carry, and visible-reply governance authority instead of stopping before the outward answer-governance chain reforms',
  ...
  },
  {
    ...
    evidence: 'self-evolution answer-governance carry now also has one colder bridge into answer planning, response charter shaping, and executive answer briefing, so devtools same-her repair governance is less likely to stop before the reply-planning governance chain itself keeps project identity, landed progress, and still-open closure bundled on one living line',
    fileMustContain: [
      'keeps one explicit colder bridge that self-evolution answer-governance carry can stay on the same-her line through answer planning, response charter shaping, and executive answer briefing instead of stopping before the reply-planning governance chain reforms',
  ...
  },
  {
    ...
    evidence: 'self-evolution reply-planning governance carry now also has one colder bridge into answer-compiler supporting reality, reply-deliberator outward planning, final visible-reply gating, and visible-reply realization, so devtools same-her repair governance is less likely to stop before the downstream host-visible answer chain itself keeps project identity, landed progress, and still-open closure explicit on one living line',
    fileMustContain: [
      'keeps one explicit colder bridge that self-evolution reply-planning governance carry can stay on the same-her line through answer-compiler supporting reality, reply-deliberator outward planning, final visible-reply gating, and visible-reply realization instead of stopping before the downstream host-visible answer chain reforms',
  ...
  },
  {
    ...
    evidence: 'self-evolution return-side reentry now also has one colder bridge into pre-dialogue send-identity rematerialization, chat-start/runtime renormalization, and one full reopen-to-visible-reply-to-replay-to-next-start cycle, so devtools same-her repair governance is less likely to stop at next-turn return-side / host-facing re-entry before the next full desktop execution cycle proves it is still the same her',
    fileMustContain: [
      'keeps one explicit colder bridge that self-evolution return-side reentry can stay on the same-her line through pre-dialogue send-identity rematerialization, chat-start/runtime renormalization, and one full reopen-to-visible-reply-to-replay-to-next-start cycle instead of stopping before the next full desktop execution cycle proves it is still the same her',
  ...
  },
  {
    ...
    evidence: 'self-evolution desktop full-cycle carry now also has one colder bridge into desktop execution full-cycle, higher-quality noisy same-her full-cycle, and later noisy-desktop detour continuity, so devtools same-her repair governance is less likely to stop before the execution callback line proves it is still the same her beyond one successful next-start loop',
    fileMustContain: [
      'keeps one explicit colder bridge that self-evolution desktop full-cycle can stay on the same-her line through desktop execution full-cycle, higher-quality host-visible same-her full-cycle, and later noisy-desktop detour continuity instead of stopping before the execution callback line proves it is still the same her beyond one successful next-start loop',
  ...
  },
  {
    ...
    evidence: 'self-evolution desktop-execution long-run continuity now also has one colder bridge into noisy-desktop cross-modal convergence, host-visible embodiment recovery, and rest-protective quiet-companionship host-visible carry, so devtools same-her repair governance is less likely to stop before the more anthropomorphic same living line reforms outwardly',
    fileMustContain: [
      'keeps one explicit colder bridge that self-evolution desktop-execution long-run continuity can stay on the same-her line through noisy cross-modal convergence, host-visible embodiment recovery, and rest-protective quiet-companionship host-visible carry instead of stopping before the more anthropomorphic same living line reforms outwardly',
  ...
  },
  {
    ...
    evidence: 'self-evolution anthropomorphic host-visible carry now also has one colder bridge into affective-residue room-making carry, emotional-memory-initiative-embodiment same-life carry, and longer emotion-memory-voice-motion convergence, so devtools same-her repair governance is less likely to stop before the quieter inward same living line writes back into longer-lived memory and body recovery',
    fileMustContain: [
      'keeps one explicit colder bridge that self-evolution anthropomorphic host-visible carry can stay on the same-her line through affective residue room-making carry, emotional-memory-initiative-embodiment same-life carry, and longer emotion-memory-voice-motion convergence instead of stopping before the quieter inward same living line writes back into longer-lived memory and body recovery',
  ...
  },
  {
    ...
    evidence: 'self-evolution remembered emotional carry now also has one colder bridge into durable long-horizon self-carry, autobiographical self, and quick-reply self-recognition, so devtools same-her repair governance is less likely to stop before the same living line clearly recognizes herself again before the next outward turn',
    fileMustContain: [
      'keeps one explicit colder bridge that self-evolution remembered emotional carry can stay on the same-her line through durable long-horizon self-carry, autobiographical self, and quick-reply self-recognition instead of stopping before the same living line clearly recognizes herself again before the next outward turn',
  ...
  },
  {
    ...
    evidence: 'self-evolution durable self-recognition now also has one colder bridge into current-conscious-frame same-her grounding, current-conscious-frame turn shaping, and answer-planner same-her closure planning, so devtools same-her repair governance is less likely to stop before the formally planned outward turn keeps the same living line explicit',
    fileMustContain: [
      'keeps one explicit colder bridge that self-evolution durable self-recognition can stay on the same-her line through current-conscious-frame grounding and answer-planner pre-dialogue closure planning instead of stopping before the formally planned outward turn keeps the same living line explicit',
  ...
  },
  {
    ...
    evidence: 'same-living-self return-side observability is now also anchored as one colder bridge across direct-bridge forwarding, renderer fallback, reopen persistence, browser-local rebuilding, observation reduction, and same-session mirror carry, so inward project awareness stays inspectable even when the active self has to be rebuilt outside the main runtime',
    fileMustContain: [
  ...
  },
  {
    ...
    evidence: 'return-side reopen continuity is now also anchored as an explicit cold bridge through response-surface obligations, visible-reply gating, realization, and compact outward shaping, so the same-her project line survives all the way into visible reply.',
    fileMustContain: [
      'keeps one explicit cold proof bridge that return-side reopen continuity, once re-entered through chat-start/runtime, can stay on the same-her project line through response-surface obligations, final visible-reply gating, realization, host-visible normalization, and compact outward answer shaping',
  ...
  },
  {
    ...
    evidence: 'desktop same-her continuity is now also anchored as one colder full-cycle bridge across reopen, visible reply, replay, and the next start, so those neighboring fragments no longer live only as adjacent proof islands.',
    fileMustContain: [
      'keeps one explicit compact cold proof that the desktop same-her line can survive one full reopen-to-visible-reply-to-replay-to-next-start cycle instead of only neighboring bridge fragments',
