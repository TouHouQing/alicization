...
const coverageRows = [
  ...
  },
  {
    ...
    evidence: 'chat-start, chat-entry, provider-consumer, autonomous-dialogue, and execution-dispatch seams are now structurally discovered and classified in one repo-level governance registry, and current runtime-owned autonomous dialogue family signals stay explicit, so new entrypoint families are less likely to silently bypass same-her project awareness ownership rules',
    fileMustContain: [
  ...
  },
  {
    ...
    fileMustContain: [
      ...
      'expect.objectContaining({ entry: \'fallback-entry-keeps-shared-chat-store-path\' })',
      'expect.objectContaining({ entry: \'desktop-main-chat-fallback-entry-keeps-shared-chat-store-path\' })',
      'expect.objectContaining({ entry: \'devtools-fallback-entry-keeps-shared-chat-store-path\' })',
  ...
  },
  {
    ...
    fileMustContain: [
      ...
      'expect.objectContaining({ entry: \'context-bridge-no-fake-local-injection\' })',
  ...
  },
  {
    ...
    evidence: 'return-side renderer observation bridges, meta bridges, normalization authorities, ingest boundaries, session sanitization, persistence, and observation reducers stay explicitly registered and constrained so same-her project awareness survives the full return-side rebuild path instead of fragmenting into untracked desktop bridge seams',
    fileMustContain: [
  ...
  },
  {
    ...
    fileMustContain: [
      ...
      'keeps broader return-side project-awareness candidate discovery broad enough to catch renderer observation bridges, renderer meta normalization, structured payload normalization, chat-stream ingest, session sanitization, and browser-side observation persistence instead of only one rebuild seam flavor',
