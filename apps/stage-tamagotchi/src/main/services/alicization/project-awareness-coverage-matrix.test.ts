...
const coverageRows = [
  ...
  },
  {
    ...
    evidence: 'broader autonomous-dialogue candidate discovery now also feeds the same top-level completeness guard beyond the explicit runtime-owned dialogue registry, so proactive authority, reminder/callback entry, and subconscious carry seams stay synchronized with the broader scan before future runtime-owned dialogue families can drift in invisibly',
    fileMustContain: [
      ...
      'keeps broader autonomous-dialogue candidate discovery broad enough to catch proactive authority, reminder/callback entry, and subconscious carry seams instead of only one runtime-owned dialogue flavor',
