...
type MemoryWorkbenchTransportParity = [
  ...
  Assert<Equal<Eventa.AlicizationMemoryQualityGoldLabelPayload, Shared.AlicizationMemoryQualityGoldLabelPayload>>,
  Assert<Equal<Eventa.AlicizationMemoryQualityGoldLabelItem, Shared.AlicizationMemoryQualityGoldLabelItem>>,
  Assert<Equal<Eventa.AlicizationMemoryQualityGoldLabelListPayload, Shared.AlicizationMemoryQualityGoldLabelListPayload>>,
  Assert<Equal<Eventa.AlicizationMemoryQualityGoldLabelListResult, Shared.AlicizationMemoryQualityGoldLabelListResult>>,
  Assert<Equal<Eventa.AlicizationMemoryQualityMonthlyGoldRegressionPack, Shared.AlicizationMemoryQualityMonthlyGoldRegressionPack>>,
  Assert<Equal<Eventa.AlicizationMemoryQualityMonthlyGoldRegressionPayload, Shared.AlicizationMemoryQualityMonthlyGoldRegressionPayload>>,
  ...
  Assert<Equal<Eventa.AlicizationMemoryEmbeddingProgress, Shared.AlicizationMemoryEmbeddingProgress>>,
  ...
  Assert<Equal<MemorySemanticScaleSoakReport, Shared.AlicizationMemorySemanticScaleSoakReport>>,
  Assert<Equal<Shared.AlicizationMemorySemanticScaleSoakReport, NonNullable<Shared.AlicizationMemoryQualityTrialReport['semanticScaleSoak']>>>,
