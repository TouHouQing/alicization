...
import Header from '@proj-alicization/stage-layouts/components/Layouts/Header.vue'
import InteractiveArea from '@proj-alicization/stage-layouts/components/Layouts/InteractiveArea.vue'
import MobileHeader from '@proj-alicization/stage-layouts/components/Layouts/MobileHeader.vue'
import MobileInteractiveArea from '@proj-alicization/stage-layouts/components/Layouts/MobileInteractiveArea.vue'
import workletUrl from '@proj-alicization/stage-ui/workers/vad/process.worklet?worker&url'

import { BackgroundProvider } from '@proj-alicization/stage-layouts/components/Backgrounds'
import { useBackgroundThemeColor } from '@proj-alicization/stage-layouts/composables/theme-color'
import { useBackgroundStore } from '@proj-alicization/stage-layouts/stores/background'
...
import { dispatchWebVoiceTurn } from './index.voice'
